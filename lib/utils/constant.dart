...
class Constant {
  ...
  static bool showGoogleMap = true;
  ...
  //   country: LocalizedString(canonical: 'Egypt'),
  // );
  ...
  // Ref: countrycode.org
  static const String defaultCountryCode = 'AE';

  // Calling code of country
  static const String defaultPhoneCode = '971';
  ...
  static int nativeAdsAfterItemNumber = 12; //Only add even numbers

  //Notification Topics
  static const String generalNotificationTopic = 'allUsers';
