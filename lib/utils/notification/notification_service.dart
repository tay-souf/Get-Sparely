...
class NotificationService {
  ...
  static void handleNotification(
    ...
    if (notificationType == Constant.notificationTypeChat) {
  ...
  static void onTapNotificationHandler(context) {
    onMessageOpen = FirebaseMessaging.onMessageOpenedApp.listen((
      ...
      if (message.data['type'] == Constant.notificationTypeChat) {
        ...
        var id = int.tryParse(message.data["item_id"]);
        if (id == null) return;
        Navigator.pushNamed(
          Constant.navigatorKey.currentContext!,
      ...
      } else if (message.data['type'] == Constant.notificationTypeItemReview) {
        MainActivity.globalKey.currentState?.onItemTapped(3);
        HelperUtils.goToNextPage(
