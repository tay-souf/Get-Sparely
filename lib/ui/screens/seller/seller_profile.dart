  ...
  static Route route(RouteSettings routeSettings) {
    ...
    return MaterialPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: SellerProfileScreen(sellerId: arguments?['sellerId']),
      ),
    );
  }
}
...
class SellerProfileScreenState extends State<SellerProfileScreen>
  ...
  void _reviewLoadMore() async {
    if (context.read<FetchSellerRatingsCubit>().hasMoreData()) {
      context.read<FetchSellerRatingsCubit>().fetchMore(
        sellerId: widget.sellerId,
      );
    }
  }
            ...
            if (state is FetchSellerRatingsSuccess) {
              return NestedScrollView(
                ...
                body: SafeArea(
                  ...
                  child: TabBarView(
                    controller: _tabController,
                    children: [liveAdsWidget(), ratingsListWidget()],
                  ),
                ),
              );
            }
            ...
            Row(
              ...
              children: [
                Column(
                  children: [
                    Text(
                      seller.averageRating!.toStringAsFixed(2).toString(),
                    ...
                    CustomRatingBar(
                      ...
                      inactiveColor: context.color.textLightColor.withValues(
                        alpha: 0.1,
                      ),
  ...
  Widget buildItemsShimmer(BuildContext context) {
    return ListView(
      ...
      children: [
        Row(spacing: 10, children: List.generate(2, (index) => getShimmer())),
        SizedBox(height: 5),
        Row(spacing: 10, children: List.generate(2, (index) => getShimmer())),
      ],
    );
