...
class _ChatScreenState extends State<ChatScreen>
  ...
  bool get isInactive {
    ...
    return status == Constant.statusReview ||
  ...
  String get translatedStatus {
    ...
    final translatable = <String>[];
    for (int i = 0; i < parts.length; ++i) {
      if (i == 0) {
        translatable.add(parts[i]);
        continue;
      }

      translatable.add(parts[i].firstUpperCase());
    }

    return translatable.join('').translate(context);
  }
                          ...
                          builder: (context, blockedUsersListState) {
                            if (isBlocked) {
                              ...
                              >(
                                listener: (context, unblockState) {
                                  if (unblockState is UnblockUserSuccess) {
                                    ...
                                    HelperUtils.showSnackBarMessage(
                                      context,
                                      'userUnblockedSuccessfully'.translate(
                                        context,
                                      ),
                                    );
                                ...
                                child: Container(
                                  ...
                                  child: InkWell(
                                    child: CustomText(
                                      "youBlockedThisContact".translate(
                                        context,
                                      ),
                              ...
                              return Container(
                                ...
                                alignment: Alignment.center,
                                child: CustomText(
                                  "${"thisItemIs".translate(context)} ${translatedStatus}",
