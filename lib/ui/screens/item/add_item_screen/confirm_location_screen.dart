                  ...
                  onPressed: () async {
                    ...
                    try {
                      ...
                      if (widget.isEdit ?? false) {
                        ...
                        print('swipImage in confirm: ${widget.swipImage?.path}');
                        return;
                      }
                    } catch (e, st) {
                      log('$e', name: 'Add Item');
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      if (Constant.mapProvider == 'free_api')
                        FilledButton(
                          onPressed: () async {
                            print('swipImage in confirm_location_screen: ${widget.swipImage?.path}');
                            final location =
