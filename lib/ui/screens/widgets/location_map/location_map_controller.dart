...
class LocationMapController extends ChangeNotifier {
  ...
  void init() async {
    ...
    if (initialCoordinates != null) {
      ...
      final location = HiveUtils.getLocation();

      if (location == null || !location.hasCoordinates) {
        _location =
            await _locationUtility.getLocation() ?? Constant.defaultLocation;
      } else {
        _location = location;
      }
      ...
      _updatePosition(
        LatLng(
          _location.latitude ?? Constant.defaultLatitude,
          _location.longitude ?? Constant.defaultLongitude,
        ),
      );
    }
  }
