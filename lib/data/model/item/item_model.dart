...
class ItemModel {
  ...
  ItemModel.fromJson(Map<String, dynamic> json) {
    swipTitle = json['swip_title'];
    swipImage = json['swip_image'];
    if (json['area'] != null) {
      areaId = json['area']['id'];
      area = json['area']['name'];
    }
    ...
    image = json['image'];
    if (json['swip_image'] != null) {
      String rawSwipImage = json['swip_image'];
      if (rawSwipImage.startsWith('http')) {
        // إذا كان الرابط كاملًا بالفعل
        swipImage = rawSwipImage;
      } else {
        // إزالة أي "storage/" زائدة وتكوين الرابط الكامل
        String cleanPath = rawSwipImage.replaceFirst('storage/', '');
        swipImage = '${Constant.baseUrl}/storage/$cleanPath';
      }
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['swip_title'] = swipTitle;
    data['swip_image'] = swipImage;
    data['price'] = price;
