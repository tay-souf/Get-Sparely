...
class CategoryModel {
  ...
  @override
  String toString() {
    return 'CategoryModel(id: $id, translated_name: $name, url: $url, description: $description, children: $children, subcategories_count: $subcategoriesCount, is_job_category: $isJobCategory, price_optional: $priceOptional, slug: $slug)';
  }
}
