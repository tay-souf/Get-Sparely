...
class AppSettings {
  ...
  static const String applicationName = 'Get Sparely App';
  static const String packageName = 'com.khetelehteraf.sparely';

  static const String demoUrl = "https://auth.getsparely.com/";

  ///API Setting

  static const int apiDataLoadLimit = 20;
  static const int maxCategoryShowLengthInHomeScreen = 5;
  static final String baseUrl = "${HelperUtils.checkHost(demoUrl)}api/";

  static const int hiddenAPIProcessDelay = 1;

  static const String shareNavigationWebUrl = "auth.getsparely.com";
